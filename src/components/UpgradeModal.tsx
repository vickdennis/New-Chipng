      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold mb-2 tracking-tight">Upgrade to {planName}</h2>
            <p className="text-zinc-400">
              The <span className="text-white font-medium">{featureName}</span> feature is available on our {planName} plan and above.
            </p>
          </div>
          ...
          <button
            onClick={onClose}
            className="w-full mt-4 py-2 text-zinc-500 hover:text-white transition-colors text-sm font-medium"
          >
            Maybe later
          </button>
        </motion.div>
