...
export const ICON_LIST = [
  "Instagram", "Twitter", "Youtube", "Github", "Linkedin", "Facebook", "Twitch", "Tiktok", "Snapchat", "Reddit", "Discord", "Telegram", "Spotify", "Apple", "Chrome", "Slack", "Figma", "Dribbble", "Behance", "Medium", "Globe", "Mail", "Phone", "MessageCircle", "MessageSquare", "Music", "Music2", "Play", "Camera", "ShoppingBag", "Briefcase", "GraduationCap", "Heart", "Star", "Zap", "Coffee", "MapPin", "Calendar", "Clock", "Download", "ExternalLink", "FileText", "Hash", "Image", "Layers", "Layout", "LifeBuoy", "Link", "List", "Lock", "Maximize", "Mic", "Mic2", "Moon", "Package", "Paperclip", "PieChart", "Pocket", "Power", "Printer", "Radio", "RefreshCw", "Rss", "Save", "Search", "Send", "Settings", "Share2", "Shield", "Shuffle", "Smartphone", "Speaker", "Sun", "Tag", "Target", "Terminal", "ThumbsUp", "ToggleLeft", "Trash2", "TrendingUp", "Truck", "Tv", "Umbrella", "User", "Video", "Watch", "Wifi", "Wind", "X", "Leaf", "Droplets", "Mountain", "Sprout", "Hexagon", "FlaskConical", "Nut", "Circle", "Grape", "Cookie", "Gamepad", "Gamepad2", "Headphones", "Headset", "Laptop", "Tablet", "Monitor", "Cpu", "HardDrive", "Database", "Server", "Cloud", "Ghost", "Skull", "Smile", "Frown", "Meh", "Laugh", "Wink", "Angry", "Annoyed", "Confused", "Dizzy", "Expressionless", "Grimace", "Grin", "Kiss", "Neutral", "Sad", "Sleepy", "Sunglasses", "Tongue", "UpsideDown", "Vibrate", "Watch", "Clock", "Timer", "AlarmClock", "Calendar", "History", "RefreshCw", "RotateCw", "RotateCcw", "Undo", "Redo", "ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight", "ChevronUp", "ChevronDown", "ChevronLeft", "ChevronRight", "ChevronsUp", "ChevronsDown", "ChevronsLeft", "ChevronsRight", "ArrowUpRight", "ArrowUpLeft", "ArrowDownRight", "ArrowDownLeft", "Maximize", "Minimize", "Maximize2", "Minimize2", "ZoomIn", "ZoomOut", "Move", "GripVertical", "GripHorizontal", "MoreHorizontal", "MoreVertical", "Menu", "Grid", "Layout", "Columns", "Rows", "Square", "Circle", "Triangle", "Hexagon", "Octagon", "Star", "Heart", "Zap", "Flame", "Sparkles", "Flashlight", "Lightbulb", "Hammer", "Wrench", "Screwdriver", "Scissors", "Eraser", "Brush", "Paintbrush", "Palette", "Pipette", "Contrast", "Type", "Bold", "Italic", "Underline", "Strikethrough", "Code", "Code2", "Terminal", "Braces", "Parentheses", "Quote", "Hash", "AtSign", "Percent", "DollarSign", "Euro", "PoundSterling", "JapaneseYen", "Bitcoin", "Coins", "Banknote", "Trophy", "Medal", "Target", "Flag", "Anchor", "LifeBuoy", "Truck", "Car", "Bike", "Bus", "Train", "Plane", "Ship", "Rocket", "Milestone", "Map", "Layers", "Box", "Package", "Archive", "Inbox", "Outbox", "Mailbox", "Stamp", "Ticket", "Tag", "Tags", "Bookmark", "StickyNote", "Clipboard", "Selection", "MousePointer2", "Touchpad", "Keyboard", "Speaker", "Headphones", "Headset", "Mic", "Mic2", "Radio", "Tv", "Cast", "Airplay", "Monitor", "Laptop", "Tablet", "Smartphone", "Watch", "Camera", "Video", "Image", "ImageIcon", "Film", "Clapperboard"
];
