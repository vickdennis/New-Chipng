      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="pt-8 border-t border-zinc-900 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-8">
            <Link to="/privacy" className="text-zinc-600 hover:text-white transition-colors text-xs font-medium">Privacy Policy</Link>
            <Link to="/terms" className="text-zinc-600 hover:text-white transition-colors text-xs font-medium">Terms of Service</Link>
          </div>
        </div>
      </div>
    </footer>
