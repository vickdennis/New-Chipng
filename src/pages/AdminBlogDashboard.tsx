      ...
      <div className="max-w-7xl mx-auto">
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
          <div className="flex items-center gap-4">
            <Link to="/admin" className="p-3 bg-zinc-900 border border-zinc-800 rounded-2xl hover:bg-zinc-800 transition-all">
              <ArrowLeft className="w-6 h-6" />
            </Link>
            <div>
              <h1 className="text-4xl font-bold tracking-tighter">Blog Management</h1>
        ...
        <div className="grid grid-cols-1 gap-6">
          {filteredPosts.length > 0 ? (
                        ...
                        <td className="px-8 py-6">
                          <div className="flex items-center gap-4">
                            {post.coverImage ? (
                              ...
                              <div className="w-16 h-16 rounded-xl bg-zinc-800 flex items-center justify-center text-zinc-600">
                                <FileText className="w-8 h-8" />
                              </div>
                            )}
                            <div>
                              <div className="font-bold text-lg group-hover:text-lime-400 transition-colors">{post.title}</div>
                              <div className="text-sm text-zinc-500 line-clamp-1">{post.excerpt}</div>
                              <div className="flex items-center gap-2 mt-1">
                                {post.tags?.map(tag => (
                                  <span key={tag} className="text-[10px] font-bold uppercase tracking-widest bg-zinc-800 text-zinc-400 px-2 py-0.5 rounded-full">
                                    {tag}
                                  </span>
                                ))}
                              </div>
            ...
            <div className="bg-zinc-900/50 border border-zinc-800 rounded-[2.5rem] p-20 text-center">
